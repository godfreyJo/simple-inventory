...
#window title
window.title('Simple Inventory')

#window size
window.geometry("290x460")

#code to disable maximizing the size
...
login_Form.wm_geometry("290x400")
login_Form.resizable(0,0)
login_Form.configure(background="DeepSkyBlue4")
#login_Form.wm_iconbitmap('lelu.ico')

#login header
lbl_main = tkinter.Label(login_Form, text="Inventory", font=("Helvetica", 20), bg="MistyRose2", fg="white")
lbl_main.pack(fill=tkinter.X)

#blank label space for separator
lbl_blank = tkinter.Label(login_Form, text=" ", bg="DeepSkyBlue4")
lbl_blank.pack()

#welcome label
lbl_name = tkinter.Label(login_Form, text="Welcome to the Simple Inventory", bg="MistyRose2")
lbl_name.pack()

lbl_pin = tkinter.Label(login_Form, text="Please enter your PIN", bg="MistyRose2")
lbl_pin.pack()
...
#Menu Bar for Simple Inventory Menu

def about_app():
	print("App Name: Simple Inventory")
	print("App Description: Simple Inventory Login with 3 attempts security check and Simple Inventory Menu with deposit, withdrawal and statement printing options")
	print("Virtual Simple Inventory Pin ~ 12345 ~")
	print("Python Version 3.7")
	
	
	messagebox.showinfo("App Info", "App Name: Virtual Simple Inventory with Login Form and Simple Inventory Menu\n" + 
						"\nApp description:  Simple Inventory Login with 3 attempts security check and Simple Inventory Menu with Add Item, Remove and statement of Items printing options\n" + 
						"\nVirtual Simple Inventory Pin ~ 12345 ~\n" +
						"\nPython Version 3.5 \n" + 
						"\nDeveloper: Godfrey Oyugi")
...
lbl_blank = tkinter.Label(window, text=" ", bg="DeepSkyBlue4")
lbl_blank.pack()

lbl_main = tkinter.Label(window, text="Choose Your Option", font=("Helvetica", 10), bg="DeepSkyBlue4")
lbl_main.pack(fill=tkinter.X)

lbl_blank = tkinter.Label(window, text=" ", font=("Helvetica", 1), bg="DeepSkyBlue4")
lbl_blank.pack()
...
def deposit_balance():
	...
	toplevel.configure(background="DeepSkyBlue4")
	#toplevel.wm_iconbitmap('lelu.ico')
	
	label1 = tkinter.Label(toplevel, text="Deposit Menu", font=("Helvetica", 20), bg="gray1", fg="white")
	label1.pack()
	
	lbl_top_name = tkinter.Label(toplevel, text="Enter Amount To Deposit: ", bg="DeepSkyBlue4")
	lbl_top_name.pack()
	...
	lbl_blank = tkinter.Label(toplevel, text=" ", bg="DeepSkyBlue4")
	lbl_blank.pack()
...
def draw_balance():
	...
	lbl_top_name = tkinter.Label(toplevel, text="Enter Amount To Withdraw: ", bg="DeepSkyBlue4")
	lbl_top_name.pack()
